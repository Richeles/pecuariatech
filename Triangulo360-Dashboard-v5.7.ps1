# Triângulo 360° v5.7 — PecuariaTech Cloud Dashboard
# --------------------------------------------------------------
# Consulta Supabase → view triangulo_monitor_v55
# Exibe status por módulo + progresso e percentual de estabilidade

$ErrorActionPreference = "Stop"
$logPath = "C:\Logs\PecuariaTech"
if (!(Test-Path $logPath)) { New-Item -ItemType Directory -Path $logPath | Out-Null }

$logFile = "$logPath\triangulo360_dashboard_v57.csv"
...
Clear-Host
Write-Line "🚀 Triângulo 360° v5.7 — PecuariaTech Cloud Dashboard" "Cyan"
Write-Line "--------------------------------------------------------------" "DarkGray"
...
try {
    ...
    Write-Line "--------------------------------------------------------------" "DarkGray"
    Write-Line "Fim do ciclo — Triângulo 360° Dashboard v5.7" "Cyan"
}
