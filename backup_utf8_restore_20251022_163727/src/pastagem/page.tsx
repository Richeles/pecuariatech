...
export default function PastagemPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert(`ðŸŒ¿ Pastagem cadastrada com sucesso:
    ðŸ“ Nome: ${nome}
    ðŸ“ Ãrea: ${area} hectares
    ðŸŒ¾ Tipo de capim: ${capim}
    ðŸ“… Ãšltima rotaÃ§Ã£o: ${ultimaRotacao}`);
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-4">ðŸŒ¿ Cadastro de Pastagem</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
        ...
        <div>
          <label className="block font-medium">Ãrea (hectares)</label>
          <input
            type="number"
            value={area}
