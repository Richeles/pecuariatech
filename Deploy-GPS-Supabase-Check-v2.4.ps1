# ================================================
# Deploy-GPS-Supabase-Check-v2.4.1.ps1
# ================================================
...
# ================================================
$start = Get-Date
Log "Iniciando verificação v2.4.1 (GPS + Supabase + Domínio + CSV + Agendamento)" "Cyan"
...
$csvFile = Join-Path $LogsDir ("deploy_metrics_v2.4.1_{0}.csv" -f (Get-Date -Format "yyyy-MM-dd_HH-mm-ss"))
...
$TaskName = "Deploy-GPS-Supabase-Check-v2.4.1"
if (-not (Get-ScheduledTask -TaskName $TaskName -ErrorAction SilentlyContinue)) {
    $action = New-ScheduledTaskAction -Execute "PowerShell.exe" -Argument "-NoProfile -ExecutionPolicy Bypass -File `"$ProjectPath\Deploy-GPS-Supabase-Check-v2.4.ps1`""
