  ...
  const planos = [
    ...
    },
    {
      ...
      beneficios: [
        ...
        "Relatórios enviados no Telegram",
      ],
    ...
    },
    {
      ...
      beneficios: [
        ...
        "IA Intermediária (análises básicas + alertas)",
        "Suporte via Telegram (prioritário)",
    ...
    },
    {
      ...
      beneficios: [
        ...
        "Relatórios avançados automáticos",
        "Relatórios enviados no WhatsApp",
        "Alertas inteligentes (peso, clima, pasto)",
        "UltraBiológica v1.0",
        "Planilhas Ultra (todas inclusas)",
        "Checklist Premium",
        "Relatório mensal automático (premium)",
