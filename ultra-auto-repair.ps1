#Requires -Version 7
<#
  Script: ultra-auto-repair.ps1
  Autor: Assistente GPT-5
  Versão: 7.0
  Função: Corrigir todos os erros estruturais e de encoding do projeto PecuariaTech Cloud
#>
...
Write-Host "`n🧠 Ultra Auto Repair — PecuariaTech Cloud v7.0" -ForegroundColor Cyan
Write-Host "------------------------------------------------------`n"

# 1️⃣ Corrigir todos os arquivos com encoding corrompido
Write-Host "🧩 Etapa 1: Varredura e correção de encoding..." -ForegroundColor Yellow
