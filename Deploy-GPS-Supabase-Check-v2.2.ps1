# Deploy-GPS-Supabase-Check-v2.2.ps1
# Verificacao GPS + Supabase + Dominio + CSV auditavel
...
$CsvFile = "$LogDir\deploy_metrics_$Ts.csv"
...
Log "Inicio da verificacao v2.2 (GPS + Supabase + Dominio + CSV)."
$start = Get-Date
...
Log "Verificacao v2.2 concluida com sucesso." "Green"
