<#
🌾 Triângulo360 AutoFix v7.5.2 — versão com correção de path e modo service-ready
...
$CSV = Join-Path $LOGS "autofix_v752.csv"
$HTML_PATH = Join-Path $LOGS "autofix_v752.html"
...
function Generate-HTML {
  ...
  $html_content = @"
<!doctype html>
<html><head><meta charset='utf-8'/><title>Triângulo360 AutoFix v7.5.2</title>
...
<body>
<h2>🌾 Triângulo360 AutoFix v7.5.2</h2>
...
{title:'Pirâmide de Falhas 3D',margin:{l:150}});
