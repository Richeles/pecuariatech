Write-Host "🔧 UltraFix 360º v3 — Correções completas Next.js 15..." -ForegroundColor Cyan
...
# ============================
# 5) Corrigir src/rebanho/page.tsx (NOVO)
# ============================
$rebanho = "src/rebanho/page.tsx"
if (Test-Path $rebanho) {
    Write-Host "📝 Corrigindo página de Rebanho..."
...
'@
    ...
    Set-Content $rebanho -Value $fixRebanho -Encoding UTF8
    Write-Host "✅ page.tsx do Rebanho corrigido!"
}

# ============================
# 6) Limpar cache e build
# ============================
