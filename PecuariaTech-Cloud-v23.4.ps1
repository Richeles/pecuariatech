# ======================================================================
# PECUARIATECH CLOUD v23.4 — FIX TRIANGULO 360
# ======================================================================
...
$backupZip = "$backupRoot\backup_v23_4_$stamp.zip"
...
# ======================================================================
# LIMPAR src/lib (duplicado)
# ======================================================================

$srcLib = "$base\src\lib"
if (Test-Path $srcLib) {
    Write-Host "Removendo src/lib duplicado..."
    Remove-Item -Recurse -Force $srcLib
}

# ======================================================================
# RECRIAR lib/ COMPLETA
# ======================================================================
...
Write-Host "Libs corrigidas com sucesso."
Write-Host ""
...
Write-Host "login/page.tsx corrigido."
Write-Host ""
...
Write-Host "admin/page.tsx corrigido."
Write-Host ""
...
Write-Host "=== PECUARIATECH CLOUD v23.4 FINALIZADO ==="
