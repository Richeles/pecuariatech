# ============================================================
# PECUARIATECH - TRIÂNGULO 360° SERVICE v17.0 (PowerShell 7+)
# DNS + HTTPS + REST + JSON + HTML + Supabase com correção
# ============================================================

Clear-Host
[Console]::OutputEncoding = [System.Text.Encoding]::UTF8
Write-Host "[INFO] Iniciando PecuariaTech-Service v17.0..." -ForegroundColor Cyan
...
while ($true) {
    ...
    # HealthScore baseado apenas nos testes (DNS/HTTPS/REST)
    $total = $results.Count
    ...
    if ($firstRun) {
        ...
        try {
            ...
            Log "Não foi possível abrir o HTML automaticamente." "WARN"
        }
    }
