<#
🌾 Triângulo360 AutoFix v7.5.1 — Supabase + REST + Painel + AutoLogs + Alertas
...
$CSV = "$LOGS\autofix_v751.csv"
$HTML = "$LOGS\autofix_v751.html"
...
function Generate-HTML {
  ...
  $html = @"
<!doctype html>
<html><head><meta charset='utf-8'/><title>Triângulo360 AutoFix v7.5.1</title>
...
<body>
<h2>🌾 Triângulo360 AutoFix v7.5.1</h2>
...
"@
  [System.IO.File]::WriteAllText($HTML, $html)
